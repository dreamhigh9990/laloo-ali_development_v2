...
class MenuBarState extends State<SideBarMenu> {
  /// open expanstion onlick and close previous
          ...
          child: childCategories.isEmpty
              ...
              : ExpansionTile(
                  ...
                  onExpansionChanged: (bool isOpen) {
                    if (expensionTileId == currentCategory.id) {
                      setState(() {
                        expensionTileId = '';
                      });
                    } else {
                      setState(() {
                        expensionTileId = currentCategory.id.toString();
                      });
                    }
                  },
                  initiallyExpanded: expensionTileId == currentCategory.id,
                  title: Padding(
          ...
          ExpansionTile(
            ...
            onExpansionChanged: (bool isOpen) {
              if (childsId == i.id) {
                ...
                childsId = i.id.toString();
              }
            },
            initiallyExpanded: childsId == i.id,
            title: Padding(
