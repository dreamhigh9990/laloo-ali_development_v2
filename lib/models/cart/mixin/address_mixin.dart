    ...
    try {
      ...
      if (json != null) {
        ...
        if (userJson != null) {
          ...
          return Address(
              alias: user.billing != null && user.billing!.alias!.isNotEmpty
                  ? user.billing!.alias
                  : '',
              vatNumber:
                  user.billing != null && user.billing!.vatNumber!.isNotEmpty
              ...
              block: user.billing != null && user.billing!.address2!.isNotEmpty
                  ...
                  : '',
              apartment:
                  user.billing != null && user.billing!.address2!.isNotEmpty
                      ? user.billing!.company
                      : '',
              country: user.billing != null && user.billing!.country != null
