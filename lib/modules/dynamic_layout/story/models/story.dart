...
class Story {
  ...
  Story copy() {
    return Story(
      contents:
          contents!.map(StoryContent.copyWith).toList(),
      layout: layout,
      urlImage: urlImage,
    );
  }
...
class StoryTypography {
  ...
  StoryTypography({
    this.font = FontFamily.pFCenturyRegular,
    this.fontSize = 15.0,
...
// ignore: prefer_constructors_over_static_methods
  static StoryTypography get createEmpty => StoryTypography(
      font: FontFamily.pFCenturyRegular,
      fontSize: 15.0,
      fontStyle: 'normal',
      align: 'center',
      transform: 'normal',
  ...
  StoryTypography.fromJson(Map<dynamic, dynamic> json) {
    font = json['font'] ?? FontFamily.pFCenturyRegular;
    // ignore: avoid_as
  ...
  Map<String, dynamic> toJson() {
    return {
      'font': font ?? FontFamily.pFCenturyRegular,
