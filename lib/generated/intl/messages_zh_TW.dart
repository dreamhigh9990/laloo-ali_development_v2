...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "您的可用積分： ${point}";

  static String m1(state) => "藍牙狀態是 ${state}";

  static String m2(day) => "${day} 天前";

  static String m3(total) => "~${total} 公里";

  static String m4(timeLeft) => "以 ${timeLeft} 結尾";

  static String m5(message) => "錯誤： ${message}";

  static String m6(time) => " ${time}到期";

  static String m7(total) => ">${total} 公里";

  static String m8(hour) => "${hour} 小時前";

  static String m9(message) => "請求數據時應用出現問題，請聯繫管理員解決問題： ${message}";

  static String m10(size) => "最大文件大小： ${size} MB";

  static String m11(minute) => "${minute} 分鐘前";

  static String m12(month) => "${month} 個月前";

  static String m13(itemCount) => "${itemCount} 項";

  static String m14(price) => "選項總數： ${price}";

  static String m15(total) => "數量： ${total}";

  static String m16(percent) => "銷售額 ${percent}%";

  static String m17(second) => "${second} 秒前";

  static String m18(totalCartQuantity) => "購物車， ${totalCartQuantity} 件商品";

  static String m19(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m20(total) => "${total} 個商品";

  static String m21(date) => "有效期至 ${date}";

  static String m22(message) => "警告： ${message}";

  static String m23(default_currency) =>
      "當前選擇的貨幣不適用於電子錢包功能，請將其更改為 ${default_currency}";

  static String m24(length) => "我們找到了 ${length} 件商品";

  static String m25(week) => "第 ${week} 週";

  static String m26(year) => "${year} 年前";

  static String m27(total) => "您已指定訂單 #${total}";
