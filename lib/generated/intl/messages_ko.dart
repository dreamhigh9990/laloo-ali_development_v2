...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "사용 가능한 포인트 : ${point}";

  static String m1(state) => "블루투스 어댑터는 ${state}입니다.";

  static String m2(day) => "${day} 일 전";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => " ${timeLeft}로 끝남";

  static String m5(message) => "오류 : ${message}";

  static String m6(time) => " ${time}후 만료";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "${hour} 시간 전";

  static String m9(message) =>
      "데이터를 요청하는 동안 앱에 문제가 있습니다. 문제를 해결하려면 관리자에게 문의하세요. ${message}";

  static String m10(size) => "최대 파일 크기 : ${size} MB";

  static String m11(minute) => "${minute} 분 전";

  static String m12(month) => "${month} 개월 전";

  static String m13(itemCount) => "${itemCount} 항목";

  static String m14(price) => "총 옵션 : ${price}";

  static String m15(total) => "수량: ${total}";

  static String m16(percent) => "판매 ${percent} %";

  static String m17(second) => "${second} 초 전";

  static String m18(totalCartQuantity) => "장바구니, ${totalCartQuantity} 개 항목";

  static String m19(numberOfUnitsSold) => "판매 : ${numberOfUnitsSold}";

  static String m20(total) => "${total} 제품";

  static String m21(date) => " ${date}까지 유효";

  static String m22(message) => "경고 : ${message}";

  static String m23(default_currency) =>
      "현재 선택한 통화는 지갑 기능에 사용할 수 없습니다. ${default_currency}(으)로 변경하십시오.";

  static String m24(length) => " ${length} 개의 제품을 찾았습니다.";

  static String m25(week) => "주 ${week}";

  static String m26(year) => "${year} 년 전";

  static String m27(total) => "주문 번호${total}에 할당했습니다.";
