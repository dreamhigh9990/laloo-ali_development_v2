...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Điểm hiện có của bạn: ${point}";

  static String m1(state) => "Bộ điều hợp Bluetooth là ${state}";

  static String m2(day) => "${day} days ago";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Kết thúc sau ${timeLeft}";

  static String m5(message) => "Lỗi: ${message}";

  static String m6(time) => "Hết hạn sau ${time}";
  ...
  static String m10(size) => "Kích thước tệp tối đa: ${size} MB";

  static String m11(minute) => "${minute} minutes ago";

  static String m12(month) => "${month} tháng trước";

  static String m13(itemCount) => "${itemCount} items";

  static String m14(price) => "Tổng số tùy chọn: ${price}";

  static String m15(total) => "Số lượng: ${total}";
  ...
  static String m19(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m20(total) => "${total} sản phẩm";

  static String m21(date) => "Có hiệu lực cho đến ${date}";
  ...
  static String m24(length) => "Chúng tôi tìm thấy ${length} sản phẩm";

  static String m25(week) => "Tuần ${week}";

  static String m26(year) => "${year} năm trước";

  static String m27(total) => "Bạn đã chỉ định đơn đặt hàng số${total}";
