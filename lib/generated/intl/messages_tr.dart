...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Mevcut noktalarınız: ${point}";

  static String m1(state) => "Bluetooth Adaptörü: ${state}";

  static String m2(day) => "${day} Gün önce";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Ends in ${timeLeft}";

  static String m5(message) => "Hata: ${message}";

  static String m6(time) => " ${time}içinde süresi doluyor";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "${hour} Saat önce";
  ...
  static String m10(size) => "Maksimum dosya boyutu: ${size} MB";

  static String m11(minute) => "${minute} Dakika önce";

  static String m12(month) => "${month} ay önce";

  static String m13(itemCount) => "${itemCount} ürün";

  static String m14(price) => "Toplam seçenek: ${price}";

  static String m15(total) => "Adet: ${total}";

  static String m16(percent) => "% ${percent} İndirim ";

  static String m17(second) => "${second} Saniye önce";

  static String m18(totalCartQuantity) => "${totalCartQuantity} ürün, Sepette";

  static String m19(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m20(total) => "${total} ürün";

  static String m21(date) => " ${date}tarihine kadar geçerlidir";

  static String m22(message) => "Hata: ${message}";
  ...
  static String m24(length) => " \$${length} Ürün Bulundu";

  static String m25(week) => " ${week}haftası";

  static String m26(year) => "${year} yıl önce";

  static String m27(total) => "#${total}numaralı siparişe atadınız";
