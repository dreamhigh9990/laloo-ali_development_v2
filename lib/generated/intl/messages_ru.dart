...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Ваши доступные баллы: ${point}";

  static String m1(state) => "Адаптер Bluetooth: ${state}";

  static String m2(day) => "${day} дней назад";
  ...
  static String m6(time) => "Срок действия истекает через ${time}";

  static String m7(total) => ">${total} км";

  static String m8(hour) => "${hour} часов назад";
  ...
  static String m10(size) => "Максимальный размер файла: ${size} МБ";

  static String m11(minute) => "${minute} минут назад";

  static String m12(month) => "${month} месяцев назад";

  static String m13(itemCount) => "${itemCount} товаров";

  static String m14(price) => "Всего вариантов: ${price}";

  static String m15(total) => "Кол-во: ${total}";

  static String m16(percent) => "Распродажа ${percent} %";

  static String m17(second) => "${second} секунд назад";
  ...
  static String m20(total) => "${total} продуктов";

  static String m21(date) => "Действительно до ${date}";

  static String m22(message) => "Предупреждение: ${message}";
  ...
  static String m24(length) => "Мы нашли товары";

  static String m25(week) => "Неделя ${week}";

  static String m26(year) => "${year} лет назад";

  static String m27(total) => "Вы назначили заказ №${total}";
