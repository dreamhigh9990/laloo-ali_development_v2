...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Ваші доступні бали: ${point}";

  static String m1(state) => "Bluetooth-адаптер ${state}";

  static String m2(day) => "${day} днів тому";

  static String m3(total) => "~${total} км";

  static String m4(timeLeft) => "Закінчується через ${timeLeft}";

  static String m5(message) => "Помилка: ${message}";

  static String m6(time) => "Термін дії закінчується через ${time}";

  static String m7(total) => ">${total} км";

  static String m8(hour) => "${hour} годин тому";
  ...
  static String m10(size) => "Максимальний розмір файлу: ${size} МБ";

  static String m11(minute) => "${minute} хвилин тому";

  static String m12(month) => "${month} місяців тому";

  static String m13(itemCount) => "${itemCount} елементів";

  static String m14(price) => "Всього варіантів: ${price}";

  static String m15(total) => "Кількість: ${total}";

  static String m16(percent) => "Продаж ${percent}%";

  static String m17(second) => "${second} секунд тому";

  static String m18(totalCartQuantity) =>
      "Кошик, товарів: ${totalCartQuantity} ";

  static String m19(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m20(total) => "${total} продуктів";

  static String m21(date) => "Діє до ${date}";

  static String m22(message) => "Попередження: ${message}";

  static String m23(default_currency) =>
      "Вибрана валюта зараз недоступна для функції Wallet. Змініть її на ${default_currency}";

  static String m24(length) => "Ми знайшли ${length} продуктів";

  static String m25(week) => "Тиждень ${week}";

  static String m26(year) => "${year} років тому";

  static String m27(total) => "Ви призначили замовлення №${total}";
