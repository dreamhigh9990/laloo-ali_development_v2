...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Vos points disponibles: ${point}";

  static String m1(state) => "L\'adaptateur Bluetooth est ${state}";

  static String m2(day) => "il y a ${day} jours";
  ...
  static String m6(time) => "Expirant dans ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "il y a ${hour} heures";
  ...
  static String m10(size) => "Taille maximale du fichier: ${size} Mo";

  static String m11(minute) => "il y a ${minute} minutes";

  static String m12(month) => " Il y a${month} mois";

  static String m13(itemCount) => "${itemCount} produits";

  static String m14(price) => "Total des options: ${price}";

  static String m15(total) => "Qté: ${total}";

  static String m16(percent) => "Vente ${percent} %";

  static String m17(second) => "il y a ${second} secondes";
  ...
  static String m20(total) => "${total} Produits";

  static String m21(date) => "Valable jusqu\'au ${date}";
  ...
  static String m24(length) => "Nous avons trouvé des ${length} produits";

  static String m25(week) => "Semaine ${week}";

  static String m26(year) => " Il y a${year} ans";

  static String m27(total) => "Vous avez affecté à la commande n°${total}";
