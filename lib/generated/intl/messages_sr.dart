...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Доступни бодови: ${point}";

  static String m1(state) => "Bluetooth adapter je ${state}";

  static String m2(day) => "Пре ${day} Данa";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Завршава се у${timeLeft}";

  static String m5(message) => "Fehler: ${message}";

  static String m6(time) => "Истиче ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "Пре ${hour} Сати";
  ...
  static String m10(size) => "Maksimalna veličina datoteke: ${size} MB";

  static String m11(minute) => "Пре ${minute} Minuten";

  static String m12(month) => " Prije${month} mjeseci";

  static String m13(itemCount) => "${itemCount} Ставка";

  static String m14(price) => "Укупно опција: ${price}";

  static String m15(total) => "Količina: ${total}";

  static String m16(percent) => "Распродај ${percent} %";

  static String m17(second) => "Пре ${second} Минута";

  static String m18(totalCartQuantity) =>
      "корпа, ${totalCartQuantity} предмета";

  static String m19(numberOfUnitsSold) => "продато: ${numberOfUnitsSold}";

  static String m20(total) => "${total} proizvoda";

  static String m21(date) => "Датум истека ${date}";

  static String m22(message) => "упозорење: ${message}";
  ...
  static String m24(length) => "Пронашли смо производе";

  static String m25(week) => " ${week}. Sedmica";

  static String m26(year) => " Prije${year} godina";

  static String m27(total) => "Dodijelili ste narudžbi br.${total}";
