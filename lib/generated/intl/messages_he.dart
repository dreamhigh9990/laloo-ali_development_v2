...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(state) => "מתאם Bluetooth הוא ${state}";

  static String m2(day) => "לפני {יום} ימים";

  static String m3(total) => "~${total} ק\"מ";

  static String m4(timeLeft) => "מסתיים בעוד ${timeLeft}";

  static String m5(message) => "שגיאה: ${message}";

  static String m6(time) => "יפוג בעוד ${time}";

  static String m7(total) => ">${total} ק\"מ";

  static String m8(hour) => "לפני {שעה} שעות";

  static String m9(message) =>
      "יש בעיה באפליקציה במהלך בקשת הנתונים, אנא פנה למנהל לתיקון הבעיות: ${message}";

  static String m10(size) => "גודל קובץ מקסימלי: ${size} מגה בייט";

  static String m11(minute) => "לפני {דקה} דקות";

  static String m12(month) => " לפני${month} חודשים";

  static String m13(itemCount) => "${itemCount} פריטים";

  static String m14(price) => "סה\"כ אפשרויות: ${price}";

  static String m15(total) => "כמות: ${total}";

  static String m16(percent) => "הנחה ${percent}%";

  static String m17(second) => "לפני ${second} שניות";

  static String m18(totalCartQuantity) =>
      "עגלת קניות, ${totalCartQuantity} פריטים";

  static String m19(numberOfUnitsSold) => "נמכר: ${numberOfUnitsSold}";

  static String m20(total) => "${total} מוצרים";

  static String m21(date) => "תקף עד ${date}";

  static String m22(message) => "אזהרה: ${message}";

  static String m23(default_currency) =>
      "המטבע שנבחר כרגע אינו זמין עבור תכונת הארנק, שנה אותו ל- ${default_currency}";

  static String m24(length) => "מצאנו ${length} מוצרים";

  static String m25(week) => "שבוע ${week}";

  static String m26(year) => " לפני${year} שנים";

  static String m27(total) => "הקצית להזמין מספר${total}";
