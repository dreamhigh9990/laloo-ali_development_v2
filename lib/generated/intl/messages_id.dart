...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Poin Anda yang tersedia: ${point}";

  static String m1(state) => "Adaptor Bluetooth adalah ${state}";
  ...
  static String m5(message) => "Galat: ${message}";

  static String m6(time) => "Kedaluwarsa dalam ${time}";
  ...
  static String m10(size) => "Ukuran file maksimum: ${size} MB";

  static String m11(minute) => "${minute} minutes ago";

  static String m12(month) => "${month} bulan yang lalu";

  static String m13(itemCount) => "${itemCount} barang";

  static String m14(price) => "Total opsi: ${price}";

  static String m15(total) => "Jumlah: ${total}";

  static String m16(percent) => "Diskon ${percent} %";
  ...
  static String m21(date) => "Berlaku sampai ${date}";
  ...
  static String m24(length) => "Kami menemukan produk ${length}";

  static String m25(week) => "Minggu ${week}";

  static String m26(year) => "${year} tahun lalu";

  static String m27(total) => "Anda telah menetapkan untuk memesan #${total}";
