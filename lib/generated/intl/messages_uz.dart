...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Mavjud ballar: ${point}";

  static String m1(state) => "Bluetooth adapteri: ${state}";

  static String m2(day) => "${day} kun oldin";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => " ${timeLeft}da tugaydi";

  static String m5(message) => "Xato: ${message}";

  static String m6(time) => "Muddati: ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "${hour} soat oldin";
  ...
  static String m10(size) => "Maksimal fayl hajmi: ${size} MB";

  static String m11(minute) => "${minute} daqiqa oldin";

  static String m12(month) => "${month} oy oldin";

  static String m13(itemCount) => "${itemCount} ta element";

  static String m14(price) => "Jami variantlar: ${price}";

  static String m15(total) => "Miqdor: ${total}";

  static String m16(percent) => "Sotish: ${percent}%";

  static String m17(second) => "${second} soniya oldin";

  static String m18(totalCartQuantity) =>
      "Savat savati, ${totalCartQuantity} ta mahsulot";

  static String m19(numberOfUnitsSold) => "Sotilgan: ${numberOfUnitsSold}";

  static String m20(total) => "${total} ta mahsulot";

  static String m21(date) => " ${date}gacha amal qiladi";

  static String m22(message) => "Ogohlantirish: ${message}";
  ...
  static String m24(length) => "Biz ${length} ta mahsulotni topdik";

  static String m25(week) => " ${week}hafta";

  static String m26(year) => "${year} yil oldin";

  static String m27(total) => "Siz buyurtma berdingiz:${total}";
