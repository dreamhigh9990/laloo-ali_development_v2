...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Ihre verfügbaren Punkte: ${point}";

  static String m1(state) => "Bluetooth-Adapter ist ${state}";

  static String m2(day) => "Vor ${day} Tagen";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Endet in ${timeLeft}";

  static String m5(message) => "Fehler: ${message}";

  static String m6(time) => "Ablaufen in ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "Vor ${hour} Stunden";
  ...
  static String m10(size) => "Maximale Dateigröße: ${size} MB";

  static String m11(minute) => "Vor ${minute} Minuten";

  static String m12(month) => " Vor${month} Monaten";

  static String m13(itemCount) => "${itemCount} Artikel";

  static String m14(price) => "Optionen insgesamt: ${price}";

  static String m15(total) => "Menge: ${total}";

  static String m16(percent) => "Ausverkauf ${percent} %";

  static String m17(second) => "Vor ${second} Sekunden";

  static String m18(totalCartQuantity) =>
      "Warenkorb, ${totalCartQuantity} Artikel";

  static String m19(numberOfUnitsSold) => "Verkauft: ${numberOfUnitsSold}";

  static String m20(total) => "${total} Produkte";

  static String m21(date) => "Gültig bis ${date}";

  static String m22(message) => "Warnung: ${message}";
  ...
  static String m24(length) => "Wir haben die Produkte gefunden";

  static String m25(week) => "Woche ${week}";

  static String m26(year) => " Vor${year} Jahren";

  static String m27(total) => "Sie haben der Bestellung #${total}zugewiesen";
