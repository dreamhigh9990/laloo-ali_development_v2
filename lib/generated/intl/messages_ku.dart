...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "خاڵی بەردەست: ${point}";

  static String m2(day) => "${day} ڕۆژ پێش ئێستا";

  static String m4(timeLeft) => "${timeLeft} تەواو دەبێت";

  static String m5(message) => "هەڵە: ${message}";

  static String m6(time) => "بەسەردەچێت لە ${time}";

  static String m8(hour) => "${hour} کاتژمێر پێش ئێستا";
  ...
  static String m11(minute) => "${minute} خولەك پێش ئێستا";

  static String m13(itemCount) => "${itemCount} ئایتم";

  static String m14(price) => "کۆى گشتى هەڵبژاردنەکان: ${price}";

  static String m16(percent) => "داشکاندن ${percent} %";

  static String m17(second) => "${second} چرکە پێش ئێستا";
  ...
  static String m20(total) => "${total} بەرهەمەکان";

  static String m21(date) => "گونجاوە تا ${date}";

  static String m22(message) => "ئاگاداری: ${message}";

  static String m24(length) => "${length} بەرهەم دۆزرایەوە";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "privacyTerms": MessageLookupByLibrary.simpleMessage(
            "زانیاریەکانی بەکارهێنەرەکانمان بەپێی یاسای عێڕاق و هەرێمی کوردستان پارێزراو دەبن"),
