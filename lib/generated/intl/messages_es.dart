...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Tus puntos disponibles: ${point}";

  static String m1(state) => "El adaptador Bluetooth es ${state}";

  static String m2(day) => "${day}  días";
  ...
  static String m6(time) => "Caduca en ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "${hour}  horas";
  ...
  static String m10(size) => "Tamaño máximo de archivo: ${size} MB";

  static String m11(minute) => "${minute} minutos";

  static String m12(month) => " Hace${month} meses";

  static String m13(itemCount) => "${itemCount} items";

  static String m14(price) => "Total de opciones: ${price}";

  static String m15(total) => "Cantidad: ${total}";

  static String m16(percent) => "Rebaja ${percent} %";

  static String m17(second) => "${second} segundos";
  ...
  static String m20(total) => "${total} Productos";

  static String m21(date) => "Válido hasta ${date}";

  static String m22(message) => "Advertencia: ${message}";
  ...
  static String m24(length) => "Encontramos productos de ${length}";

  static String m25(week) => "Semana ${week}";

  static String m26(year) => " Hace${year} años";

  static String m27(total) => "Ha asignado a la orden #${total}";
