...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(state) => "蓝牙适配器为 ${state}";
  ...
  static String m6(time) => "在 ${time}期满";

  static String m7(total) => ">${total} 公里";

  static String m8(hour) => "${hour} 小时前";

  static String m9(message) => "应用程序在请求数据期间出现问题，请联系管理员解决问题： ${message}";

  static String m10(size) => "档案大小上限： ${size} MB";

  static String m11(minute) => "${minute} 分钟钱";

  static String m12(month) => "${month} 个月前";

  static String m13(itemCount) => "${itemCount} 件商品";

  static String m14(price) => "选项总数： ${price}";

  static String m15(total) => "数量： ${total}";

  static String m16(percent) => "出售${percent}%";
  ...
  static String m20(total) => "${total} 个产品";
  ...
  static String m24(length) => "我们找到 ${length} 个产品";

  static String m25(week) => "周 ${week}";
