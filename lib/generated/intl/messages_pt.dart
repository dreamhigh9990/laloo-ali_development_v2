...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Seus pontos disponíveis: ${point}";

  static String m1(state) => "Adaptador Bluetooth é ${state}";

  static String m2(day) => "${day} dias atrás";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Ends in ${timeLeft}";

  static String m5(message) => "Erro: ${message}";

  static String m6(time) => "Expirando em ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "${hour} horas atrás";
  ...
  static String m10(size) => "Tamanho máximo do arquivo: ${size} MB";

  static String m11(minute) => "${minute} minutos atrás";

  static String m12(month) => "${month} meses atrás";

  static String m13(itemCount) => "${itemCount} itens";

  static String m14(price) => "Opções totais: ${price}";

  static String m15(total) => "Qtd: ${total}";

  static String m16(percent) => "Desconto ${percent} %";

  static String m17(second) => "${second} segundos atrás";
  ...
  static String m20(total) => "${total} produtos";

  static String m21(date) => "Válido até ${date}";

  static String m22(message) => "Atenção: ${message}";
  ...
  static String m24(length) => "Encontramos ${length} produtos";

  static String m25(week) => "Semana ${week}";

  static String m26(year) => "${year} anos atrás";

  static String m27(total) => "Você atribuiu o pedido nº${total}";
