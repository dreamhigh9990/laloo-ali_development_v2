...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Käytettävissä olevat pisteet: ${point}";

  static String m1(state) => "Bluetooth-sovitin on ${state}";

  static String m2(day) => "${day} päivää sitten";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Päättyy ${timeLeft}";

  static String m5(message) => "Virhe: ${message}";

  static String m6(time) => "Vanhenee ${time}kuluttua";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "${hour} tuntia sitten";
  ...
  static String m10(size) => "Tiedoston enimmäiskoko: ${size} Mt";

  static String m11(minute) => "${minute} minuuttia sitten";

  static String m12(month) => "${month} kuukautta sitten";

  static String m13(itemCount) => "${itemCount} kohdetta";

  static String m14(price) => "Vaihtoehdot yhteensä: ${price}";

  static String m15(total) => "Määrä: ${total}";

  static String m16(percent) => "Alennus ${percent}%";

  static String m17(second) => "${second} sekuntia sitten";

  static String m18(totalCartQuantity) =>
      "Ostoskori, ${totalCartQuantity} tuotetta";

  static String m19(numberOfUnitsSold) => "Myyty: ${numberOfUnitsSold}";

  static String m20(total) => "${total} tuotetta";

  static String m21(date) => "Voimassa ${date}asti";

  static String m22(message) => "Varoitus: ${message}";
  ...
  static String m24(length) => "Löysimme ${length} tuotetta";

  static String m25(week) => "Viikko ${week}";

  static String m26(year) => "${year} vuotta sitten";

  static String m27(total) => "Olet määrittänyt tilauksen #${total}";
