...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Uw beschikbare punten: ${point}";

  static String m1(state) => "Bluetooth-adapter is ${state}";

  static String m2(day) => "${day} dagen geleden";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Eindigt over ${timeLeft}";

  static String m5(message) => "Fout: ${message}";

  static String m6(time) => "Verloopt over ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "${hour} uur geleden";
  ...
  static String m10(size) => "Maximale bestandsgrootte: ${size} MB";

  static String m11(minute) => "${minute} minuten geleden";

  static String m12(month) => "${month} maanden geleden";

  static String m13(itemCount) => "${itemCount} items";

  static String m14(price) => "Opties totaal: ${price}";

  static String m15(total) => "Aantal: ${total}";

  static String m16(percent) => "Verkoop ${percent} %";

  static String m17(second) => "${second} seconden geleden";

  static String m18(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} artikelen";

  static String m19(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m20(total) => "${total} producten";

  static String m21(date) => "Geldig tot ${date}";

  static String m22(message) => "Waarschuwing: ${message}";
  ...
  static String m24(length) => "We hebben ${length} producten gevonden";

  static String m25(week) => "Week ${week}";

  static String m26(year) => "${year} jaar geleden";

  static String m27(total) => "Je hebt toegewezen aan bestelling #${total}";
