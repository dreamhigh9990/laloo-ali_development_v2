...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "I tuoi punti disponibili: ${point}";

  static String m1(state) => "L\'adattatore Bluetooth è ${state}";
  ...
  static String m5(message) => "Errore: ${message}";

  static String m6(time) => "In scadenza tra ${time}";
  ...
  static String m10(size) => "Dimensione massima del file: ${size} MB";

  static String m11(minute) => "${minute} minutes ago";

  static String m12(month) => "${month} mesi fa";

  static String m13(itemCount) => "${itemCount} items";

  static String m14(price) => "Opzioni totali: ${price}";

  static String m15(total) => "Qtà: ${total}";

  static String m16(percent) => "${percent}% di sconto";
  ...
  static String m20(total) => "${total} Prodotti";

  static String m21(date) => "Valido fino alle ${date}";
  ...
  static String m24(length) => "Abbiamo trovato \$length prodotti";

  static String m25(week) => "Settimana ${week}";

  static String m26(year) => "${year} anni fa";

  static String m27(total) => "Hai assegnato all\'ordine #${total}";
