...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "您的可用积分： ${point}";

  static String m1(state) => "蓝牙状态是 ${state}";

  static String m2(day) => "${day} 天前";

  static String m3(total) => "~${total} 公里";

  static String m4(timeLeft) => "以 ${timeLeft} 结尾";

  static String m5(message) => "错误： ${message}";
  ...
  static String m9(message) => "请求数据时应用出现问题，请联系管理员解决问题： ${message}";

  static String m10(size) => "最大文件大小： ${size} MB";

  static String m11(minute) => "${minute} 分钟前";

  static String m12(month) => "${month} 个月前";

  static String m13(itemCount) => "${itemCount} 项";

  static String m14(price) => "选项总数： ${price}";

  static String m15(total) => "数量： ${total}";

  static String m16(percent) => "销售额 ${percent}%";

  static String m17(second) => "${second} 秒前";

  static String m18(totalCartQuantity) => "购物车， ${totalCartQuantity} 件商品";

  static String m19(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m20(total) => "${total} 个商品";
  ...
  static String m24(length) => "我们找到了 ${length} 件商品";

  static String m25(week) => "第 ${week} 周";

  static String m26(year) => "${year} 年前";

  static String m27(total) => "您已指定订单 #${total}";
