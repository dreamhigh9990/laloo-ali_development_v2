...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Pointi zako zinazopatikana: ${point}";

  static String m1(state) => "Adapta ya Bluetooth ni ${state}";

  static String m2(day) => " siku${day} zilizopita";

  static String m3(total) => "~${total} kilomita";

  static String m4(timeLeft) => "Inaisha baada ya ${timeLeft}";

  static String m5(message) => "Hitilafu: ${message}";

  static String m6(time) => "Inaisha baada ya ${time}";

  static String m7(total) => "> kilomita${total} ";

  static String m8(hour) => " saa${hour} zilizopita";
  ...
  static String m10(size) => "Upeo wa ukubwa wa faili: ${size} MB";

  static String m11(minute) => " dakika${minute} zilizopita";

  static String m12(month) => " Miezi${month} iliyopita";

  static String m13(itemCount) => "${itemCount} vitu";

  static String m14(price) => "Jumla ya chaguo: ${price}";

  static String m15(total) => "Kiasi: ${total}";

  static String m16(percent) => "Uuzaji ${percent}%";

  static String m17(second) => " sekunde${second} zilizopita";

  static String m18(totalCartQuantity) =>
      "Rukwama ya ununuzi, ${totalCartQuantity} vitu";

  static String m19(numberOfUnitsSold) => "Zinauzwa: ${numberOfUnitsSold}";

  static String m20(total) => "${total} bidhaa";

  static String m21(date) => "Inatumika hadi ${date}";

  static String m22(message) => "Onyo: ${message}";
  ...
  static String m24(length) => "Tulipata bidhaa ${length} ";

  static String m25(week) => "Wiki ${week}";

  static String m26(year) => " miaka${year} iliyopita";

  static String m27(total) => "Umekabidhi kuagiza #${total}";
