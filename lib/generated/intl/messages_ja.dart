...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "利用可能なポイント： ${point}";

  static String m1(state) => "Bluetoothアダプタは ${state}です";
  ...
  static String m6(time) => " ${time}で期限切れ";
  ...
  static String m10(size) => "最大ファイルサイズ： ${size} MB";

  static String m11(minute) => "${minute} minutes ago";

  static String m12(month) => "${month} か月前";

  static String m13(itemCount) => "${itemCount} items";

  static String m14(price) => "オプションの合計： ${price}";

  static String m15(total) => "数量： ${total}";

  static String m16(percent) => "セール${percent}％";
  ...
  static String m20(total) => "${total} 製品";

  static String m21(date) => " ${date}まで有効";
  ...
  static String m24(length) => "${length} 個の商品が見つかりました";

  static String m25(week) => "週 ${week}";

  static String m26(year) => "${year} 年前";

  static String m27(total) => "注文番号${total}に割り当てました";
