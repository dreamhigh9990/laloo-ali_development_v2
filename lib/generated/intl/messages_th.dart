...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "คะแนนที่คุณมี: ${point}";

  static String m1(state) => "อะแดปเตอร์บลูทูธคือ ${state}";

  static String m2(day) => "${day} วันที่ผ่านมา";

  static String m3(total) => "~${total} กม.";

  static String m4(timeLeft) => "Ends in ${timeLeft}";

  static String m5(message) => "ข้อผิดพลาด: ${message}";

  static String m6(time) => "จะหมดอายุใน ${time}";

  static String m7(total) => ">${total} กม.";

  static String m8(hour) => "${hour} ชั่วโมงที่ผ่านมา";
  ...
  static String m10(size) => "ขนาดไฟล์สูงสุด: ${size} MB";

  static String m11(minute) => "{นาที} นาทีที่ผ่านมา";

  static String m12(month) => "${month} เดือนที่แล้ว";

  static String m13(itemCount) => "${itemCount} รายการ";

  static String m14(price) => "ตัวเลือกทั้งหมด: ${price}";

  static String m15(total) => "จำนวน: ${total}";

  static String m16(percent) => "ยอดขาย ${percent} %";

  static String m17(second) => "${second} วินาทีที่ผ่านมา";
  ...
  static String m20(total) => "${total} สินค้า";

  static String m21(date) => "ใช้ได้จนถึง ${date}";

  static String m22(message) => "คำเตือน: ${message}";
  ...
  static String m24(length) => "เราพบสินค้า ${length}";

  static String m25(week) => "สัปดาห์ ${week}";

  static String m26(year) => "${year} ปีที่แล้ว";

  static String m27(total) => "คุณได้มอบหมายคำสั่งซื้อ #${total}";
