...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "نقاطك المتاحة: ${point}";

  static String m1(state) => "محول البلوتوث هو ${state}";

  static String m2(day) => "${day} أيام  ماضية";

  static String m3(total) => "~${total} كم";

  static String m4(timeLeft) => "Ends in ${timeLeft}";

  static String m5(message) => "خطأ: ${message}";

  static String m6(time) => "تنتهي الصلاحية في ${time}";

  static String m7(total) => ">${total} كم";

  static String m8(hour) => "${hour} ساعات ماضية";

  static String m9(message) =>
      "حدثت مشكلة في التطبيق أثناء طلب البيانات ، يرجى الاتصال بالمسؤول لإصلاح المشكلة: ${message}";

  static String m10(size) => "أقصى حجم للملف: ${size} ميغابايت";

  static String m11(minute) => "${minute} دقائق ماضية";

  static String m12(month) => " قبل${month} شهر";

  static String m13(itemCount) => "${itemCount} عنصر";

  static String m14(price) => "إجمالي الخيارات: ${price}";

  static String m15(total) => "الكمية: ${total}";

  static String m16(percent) => "بيع ${percent} ٪";

  static String m17(second) => "${second} ثواني ماضية";
  ...
  static String m20(total) => "${total} من المنتجات";

  static String m21(date) => "صالح حتى ${date}";

  static String m22(message) => "تحذير: ${message}";

  static String m23(default_currency) =>
      "العملة المحددة حاليًا غير متاحة لميزة المحفظة ، الرجاء تغييرها إلى ${default_currency}";

  static String m24(length) => "وجدنا منتجات ${length}";

  static String m25(week) => "الأسبوع ${week}";

  static String m26(year) => " قبل${year} سنة";

  static String m27(total) => "لقد قمت بتعيين الطلب رقم${total}";
