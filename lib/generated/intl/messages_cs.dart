...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Vaše dostupné body: ${point}";

  static String m1(state) => "Adaptér Bluetooth je ${state}";

  static String m2(day) => " Před${day} dny";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Končí za ${timeLeft}";

  static String m5(message) => "Chyba: ${message}";

  static String m6(time) => "Končí za ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => " Před${hour} hodinami";
  ...
  static String m10(size) => "Maximální velikost souboru: ${size} MB";

  static String m11(minute) => " Před${minute} minutami";

  static String m12(month) => " Před${month} měsíci";

  static String m13(itemCount) => " Položky:${itemCount} ";

  static String m14(price) => "Celkem možností: ${price}";

  static String m15(total) => "Množství: ${total}";

  static String m16(percent) => "Výprodej ${percent}%";

  static String m17(second) => " Před${second} s";

  static String m18(totalCartQuantity) =>
      "Nákupní košík, položky: ${totalCartQuantity} ";

  static String m19(numberOfUnitsSold) => "Prodáno: ${numberOfUnitsSold}";

  static String m20(total) => "${total} produktů";

  static String m21(date) => "Platí do ${date}";

  static String m22(message) => "Upozornění: ${message}";
  ...
  static String m24(length) => "Našli jsme ${length} produktů";

  static String m25(week) => "Týden ${week}";

  static String m26(year) => " Před${year} lety";

  static String m27(total) => "Přiřadili jste k objednávce č.${total}";
