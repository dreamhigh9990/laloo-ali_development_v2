...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "A rendelkezésre álló pontok: ${point}";

  static String m1(state) => "A Bluetooth-adapter ${state}";

  static String m2(day) => "${day} napja";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Ends in ${timeLeft}";

  static String m5(message) => "Hiba: ${message}";

  static String m6(time) => "Lejárat ideje: ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "${hour} órája";
  ...
  static String m10(size) => "Maximális fájlméret: ${size} MB";

  static String m11(minute) => "${minute} perce";

  static String m12(month) => "${month} hónappal ezelőtt";

  static String m13(itemCount) => "${itemCount} termékek";

  static String m14(price) => "Opciók összesen: ${price}";

  static String m15(total) => "Mennyiség: ${total}";

  static String m16(percent) => "${percent} % Kedvezmény";

  static String m17(second) => "${second} másodperce";
  ...
  static String m20(total) => "${total} termék";

  static String m21(date) => "Érvényes: ${date}";

  static String m22(message) => "Figyelmeztetés: ${message}";
  ...
  static String m24(length) => "Találtunk ${length} terméket";

  static String m25(week) => " ${week}hét";

  static String m26(year) => "${year} évvel ezelőtt";

  static String m27(total) => "Hozzárendelte a (z)${total}számú megrendelést";
