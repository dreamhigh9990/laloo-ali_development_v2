...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Twoje dostępne punkty: ${point}";

  static String m1(state) => "Adapter Bluetooth to ${state}";

  static String m2(day) => "${day} dni temu";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Kończy się za ${timeLeft}";

  static String m5(message) => "Błąd: ${message}";

  static String m6(time) => "Wygasa za ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "${hour} godz. Temu";
  ...
  static String m10(size) => "Maksymalny rozmiar pliku: ${size} MB";

  static String m11(minute) => "${minute} min temu";

  static String m12(month) => "${month} miesięcy temu";

  static String m13(itemCount) => "${itemCount} elementów";

  static String m14(price) => "Łącznie opcje: ${price}";

  static String m15(total) => "Ilość: ${total}";

  static String m16(percent) => "Wyprzedaż ${percent}%";

  static String m17(second) => "${second} sekundy temu";

  static String m18(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycje";

  static String m19(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m20(total) => "${total} produktów";

  static String m21(date) => "Ważne do ${date}";

  static String m22(message) => "Ostrzeżenie: ${message}";
  ...
  static String m24(length) => "Znaleźliśmy ${length} produktów";

  static String m25(week) => "Tydzień ${week}";

  static String m26(year) => "${year} lat temu";

  static String m27(total) => "Przypisałeś do zamówienia nr${total}";
