...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Dina tillgängliga poäng: ${point}";

  static String m1(state) => "Bluetooth-adapter är ${state}";

  static String m2(day) => "${day} dagar sedan";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Slutar om ${timeLeft}";

  static String m5(message) => "Fel: ${message}";

  static String m6(time) => "Går ut om ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "${hour} timmar sedan";
  ...
  static String m10(size) => "Maximal filstorlek: ${size} MB";

  static String m11(minute) => " För${minute} minuter sedan";

  static String m12(month) => "${month} månader sedan";

  static String m13(itemCount) => "${itemCount} objekt";

  static String m14(price) => "Totalt antal alternativ: ${price}";

  static String m15(total) => "Antal: ${total}";

  static String m16(percent) => "Försäljning ${percent}%";

  static String m17(second) => " För${second} sekunder sedan";

  static String m18(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m19(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m20(total) => "${total} produkter";

  static String m21(date) => "Gäller till ${date}";

  static String m22(message) => "Varning: ${message}";
  ...
  static String m24(length) => "Vi hittade ${length} produkter";

  static String m25(week) => "Vecka ${week}";

  static String m26(year) => " För${year} år sedan";

  static String m27(total) => "Du har tilldelat order nr${total}";
