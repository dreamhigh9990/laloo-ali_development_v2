...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Vaši dostupni bodovi: ${point}";

  static String m2(day) => "${day} dana prije";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Završava za ${timeLeft}";

  static String m5(message) => "Greška: ${message}";

  static String m6(time) => "Ističe za${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => "${hour} sati prije";
  ...
  static String m10(size) => "Maksimalna veličina fajla: ${size} MB";

  static String m11(minute) => "${minute} minuta prije";

  static String m12(month) => "${month} mjeseca prije";

  static String m13(itemCount) => "${itemCount} proizvoda";

  static String m14(price) => "Ukupno opcija: ${price}";

  static String m15(total) => "Količina: ${total}";

  static String m16(percent) => "Rasprodaja ${percent}%";

  static String m17(second) => "${second} sekundi prije";

  static String m18(totalCartQuantity) =>
      "Korpa za kupovinu, ${totalCartQuantity} proizvoda";

  static String m19(numberOfUnitsSold) => "Prodano: ${numberOfUnitsSold}";

  static String m20(total) => "${total} proizvoda";

  static String m21(date) => "Validno do ${date}";

  static String m22(message) => "Upozorenje: ${message}";
  ...
  static String m24(length) => "Pronašli smo ${length} proizvoda";

  static String m25(week) => "Sedmica ${week}";

  static String m26(year) => "${year} godine prije";

  static String m27(total) => "Dodijeljeni ste narudžbi #${total}";
