...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "Vaše body: ${point}";

  static String m1(state) => "Adaptér Bluetooth je ${state}";

  static String m2(day) => " pred${day} dňami";

  static String m3(total) => "~${total} km";

  static String m4(timeLeft) => "Končí o ${timeLeft}";

  static String m5(message) => "Chyba: ${message}";

  static String m6(time) => "Platnosť vyprší o ${time}";

  static String m7(total) => ">${total} km";

  static String m8(hour) => " pred${hour} hodinami";
  ...
  static String m10(size) => "Maximálna veľkosť súboru: ${size} MB";

  static String m11(minute) => " pred${minute} minútami";

  static String m12(month) => " pred${month} mesiacmi";

  static String m13(itemCount) => " ${itemCount} položiek";

  static String m14(price) => "Celkom: ${price}";

  static String m15(total) => "Množstvo: ${total}";

  static String m16(percent) => "Zľava ${percent}%";

  static String m17(second) => " pred ${second} sek.";

  static String m18(totalCartQuantity) =>
      "Nákupný košík, ${totalCartQuantity} položiek";

  static String m19(numberOfUnitsSold) => "Predané: ${numberOfUnitsSold}";

  static String m20(total) => "${total} produktov";

  static String m21(date) => "Platí do ${date}";

  static String m22(message) => "Upozornenie: ${message}";

  static String m23(default_currency) =>
      "Aktuálna mena nie je dostupná pre funkciu Peňaženka. Zmeňte ju na ${default_currency}";

  static String m24(length) => "Našli sme ${length} produktov";

  static String m25(week) => " ${week}. týždeň";

  static String m26(year) => " pred${year} rokmi";

  static String m27(total) => "Pridelili ste objednávke č.${total}";
