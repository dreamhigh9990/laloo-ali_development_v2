...
class S {
  ...
  /// `Shipping\nwordwide`
  String get shippingnwordwide {
    return Intl.message(
      'Shipping\nwordwide',
      name: 'shippingnwordwide',
      desc: '',
      args: [],
    );
  }
  ...
  String get youNeedToLoginAgainToEffectUpdate {
    return Intl.message(
      'You need to login again to effect update.',
      name: 'youNeedToLoginAgainToEffectUpdate',
      desc: '',
      args: [],
    );
  }
  ...
  /// `You wants to logout?`
  String get youWantsToLogout {
    return Intl.message(
      'You wants to logout?',
      name: 'youWantsToLogout',
      desc: '',
      args: [],
    );
  }
  ...
  String get yourMinimumOrderMustBe20 {
    return Intl.message(
      'Your minimum order must be €20',
      name: 'yourMinimumOrderMustBe20',
      desc: '',
      args: [],
    );
  }
  ...
  String get thisEmailAddressIsAlreadyUsed {
    return Intl.message(
      'This email address is already used. Please, choose another one or login',
      name: 'thisEmailAddressIsAlreadyUsed',
      desc: '',
      args: [],
    );
  }
