                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                if (model.shippingMethods![i].id == '393' ||
                                    model.shippingMethods![i].title
                                            ?.contains('Cash Delivery') ==
                                        true)
                                  Image.asset('assets/images/cash_d.jpeg'),
                                if (model.shippingMethods![i].id == '392' ||
                                    model.shippingMethods![i].title
                                            ?.contains('Elta') ==
                                        true)
                                  Image.asset('assets/images/courier.jpeg'),
                                Radio(
                                  value: i,
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text(
                                        model.shippingMethods![i].description ??
                                            '',
                                        style: const TextStyle(
