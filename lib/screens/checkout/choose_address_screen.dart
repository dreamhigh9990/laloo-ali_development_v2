      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            ...
            Flexible(
              child: Column(
                children: <Widget>[Text(address.alias.toString())],
              ),
            )
          ],
        ),
        ...
        Row(
          ...
          children: <Widget>[
            ...
            Flexible(
              child: Column(
                children: <Widget>[Text(address.vatNumber.toString())],
              ),
            )
          ],
        ),
    ...
    return GestureDetector(
      onTap: () {
        final add = Address(
          ...
          apartment: user!.billing!.address2,
          block: user!.billing!.company,
        ...
        log('This is billing address added: $add');
    ...
    return GestureDetector(
      onTap: () {
        final add = Address(
          ...
          apartment: user!.shipping!.address2,
          block: user!.shipping!.company,
        ...
        log('This is shipping address added: $add');
        Provider.of<CartModel>(context, listen: false).setAddress(add);
        Navigator.of(context).pop();
        widget.callback(add);
      },
